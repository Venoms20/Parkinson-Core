  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-base-200 p-6 rounded-xl shadow-lg min-h-[12rem] flex items-center justify-center transition-opacity duration-500">
          {isLoading ? (
            ...
            <p className="text-neutral/60">Clique abaixo para gerar uma mensagem de inspiração.</p>
          )}
        </div>
